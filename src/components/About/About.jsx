        ...
        <div className="row d-flex justify-content-evenly" id="aboutcontent">
          <div className="col-md-5 d-flex align-items-center" id="textAbout">
            <div id="Abouttext">
              ...
              <br />
              <p>
                Being a people's person, I was fortunate enough to gain
                experience as a Business Development Executive. During my time
                in the role, I was the in-charge of end to end processing for
                sourcing of developers on C2C or C2H basis. Managing the
                developers pool as well as companies and clients pool and
                communicating throughout the process was associated with my
                designation.
              </p>
            </div>
          </div>
